...
class KitchenController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            DB::rollback();
            Log::error('Admin kitchen user creation failed.', [
                'email' => $request->email,
                'branch_id' => $request->branch_id,
...
//        return
    ...
    {
        $kitchen = User::where('user_type', 'kitchen')->findOrFail($request->id);
    ...
    {
        $branches = Branch::orderBy('id', 'DESC')->get();
        $chef = User::where('user_type', 'kitchen')->findOrFail($request->id);
    ...
    public function update(Request $request, $id)
    {
        ...
        DB::beginTransaction();
        try {
            $chef = User::where('user_type', 'kitchen')->findOrFail($id);
            ...
            DB::rollback();
            Log::error('Admin kitchen user update failed.', [
                'chef_id' => $id,
                'branch_id' => $request->branch_id,
                'message' => $e->getMessage(),
            ]);
