                        ...
                        @php($orderMgt=\App\CentralLogics\Helpers::get_business_settings('customize_order_menu'))
                            ...
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/orders/list/*')?'active':''}}">
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    @if(isset($orderMgt['status']) && $orderMgt['status']=='1')
                                    ...
                                    @endif
                                    <li class="nav-item {{Request::is('admin/orders/all-orders')?'active':''}}">
                                        <a class="nav-link" href="{{route('admin.orders.all-orders')}}" title="">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate sidebar--badge-container">
                                                <span>{{translate('All Orders')}}</span>
                                                <span class="badge badge-soft-info badge-pill ml-1">{{\App\Model\Order::count()}}</span>
                                            </span>
                                        </a>
                                    </li>
                            ...
                            <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/addon*') ||Request::is('admin/product*')?'active':''}}">
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li class="nav-item {{Request::is('admin/addon*')?'active':''}}">
                                     ...
                                     <li class="nav-item {{Request::is('admin/badge*')?'active':''}}">
                                        <a class="nav-link " href="{{route('admin.badge.add-new')}}"
                                           title="{{translate('add badge')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span
                                                class="text-truncate">{{translate('Add Badge')}}</span>
                                        </a>
                                    </li>
...
<!-- Reward -->
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/reward*')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{route('admin.reward.list')}}"
                                >
                                    <i class="tio-image nav-icon"></i>
                                    <span
                                        class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{translate('Reward Setup')}}</span>
                                </a>
                            </li>
...
{{--                        PROMOTION MANAGEMENT--}}
                        @if(Helpers::module_permission_check('promotion_management'))
                            ...
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/poster*')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{route('admin.poster.list')}}"
                                >
                                    <i class="tio-image nav-icon"></i>
                                    <span
                                        class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{translate('poster')}}</span>
                                </a>
                            </li>
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/banner*')?'active':''}}">
                                ...
                                {{--                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"--}}
                                {{--                                    style="display: {{Request::is('admin/a*')?'block':'none'}}">--}}
                            ...
                            <!-- shohel -->
                              <li class="navbar-vertical-aside-has-menu {{Request::is('admin/advertisement*')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{route('admin.advertisement.list')}}">
                                    <i class="tio-notifications nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{translate('Advertisement Setup')}}</span>
                                </a>
                            </li>
                            ...
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/tag*')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{route('admin.tag.list')}}">
                                    <i class="tio-gift nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{translate('Tags')}}</span>
                                </a>
                            </li>
...
{{--                        HELP & SUPPORT MANAGEMENT--}}
                        @if(Helpers::module_permission_check('help_and_support_management'))
                            <li class="nav-item">
...
{{--                        REPORT & ANALYTICS MANAGEMENT--}}
                        @if(Helpers::module_permission_check('report_and_analytics_management'))
                            <li class="nav-item">
                                <small class="nav-subtitle"
...
{{--                        REPORT & ANALYTICS MANAGEMENT END--}}
                        ...
                        @if(Helpers::module_permission_check('user_management'))
                        @if(isset($userMgt['status']) && $userMgt['status']=='1')
...
{{--                            </li>--}}
                    ...
                    <!-- Table Management-->
                    @if(Helpers::module_permission_check('table_management'))
                            <li class="nav-item">
                    ...
                    <!-- Table Management End-->
                        ...
                        @if(Helpers::module_permission_check('system_management'))
                        <li class="nav-item">
                        ...
                        <!-- END Business_Setup -->
                         ...
                         @if(isset($bconfig['status']) && $bconfig['status']=='1')
                        <!--BRANCH SETUP -->
                        ...
                        <li class="navbar-vertical-aside-has-menu {{Request::is('admin/business-settings/web-app/third-party*')?'active':''}}">
                          ...
                          <li class="nav-item {{Request::is('admin/badge*')?'active':''}}">
                                        <a class="nav-link " href="{{route('admin.reviews.add-new')}}"
                                           title="{{translate('add badge')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span
                                                class="text-truncate">{{translate('Reviews')}}</span>
                                        </a>
                            </li>
                        <!-- End 3rd Party -->
                        <!-- // shohel  -->
                        <li class="nav-item {{Request::is('admin/rate/us*')?'active':''}}">
                            <a class="nav-link " href="{{route('admin.rate-us.list')}}"
                           title="{{translate('Rate Us')}}">
                            <span class="tio-circle nav-indicator-icon"></span>
                            <span
                                class="text-truncate">{{translate('Rate Us')}}</span>
                            </a>
                        </li>
