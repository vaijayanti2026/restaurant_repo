        ...
        <div id="printableAreaContent">
             ...
             <table class="" style="width: 100%;">
                <tr>
                    <td class="text-center col-12">
                        <h2 style="font-weight: lighter; margin: 0;">
            ...
            <table class="table table-bordered mt-3">
                ...
                <tbody>
                    ...
                    <tr>
                        <th colspan="2" style="text-align: right">{{ translate('Tip Price') }}:
                        </th>
                        <th style="text-align: right">{{ \App\CentralLogics\Helpers::set_symbol($order['tip_price']) }}</th>
                    </tr>
                    @if($add_ons_cost != '0')
                    <tr>
                    ...
                    <tr>
                        ...
                        <th style="text-align: right">
                            {{ \App\CentralLogics\Helpers::set_symbol($sub_total + $total_tax + $add_ons_cost+$order['tip_price']) }}</th>

                    </tr>
                    @if($order['coupon_discount_amount'] != '0')
                    <tr>
                        <th colspan="2" style="text-align: right">{{ translate('Coupon Discount') }}:</th>
                        <th style="text-align: right">
                    ...
                    <tr>
                        ...
                        <th style="font-size: 20px; text-align: right">
                             @php( $total = $sub_total + $del_c + $total_tax + $add_ons_cost - $order['coupon_discount_amount']+$order['tip_price'])
                            {{ \App\CentralLogics\Helpers::set_symbol($sub_total + $del_c + $total_tax + $add_ons_cost - $order['coupon_discount_amount']+$order['tip_price']) }}
                        </th>
                    </tr>
                </tbody>
            </table>
