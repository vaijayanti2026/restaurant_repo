...
@section('title', translate('Add new advertisement'))
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label class="input-label">{{translate('Trigger Time')}}</label>
                                            <input type="text" name="trigger_time" class="form-control" placeholder="{{translate('Enter time in seconds')}}" required>
                                        </div>
                                          ...
                                          <div class="form-group">
                                            ...
                                            <select name="item_type" class="custom-select">
                                                <option selected disabled>{{translate('select_status')}}</option>
                                                <option value="product">{{translate('Active')}}</option>
                                                <option value="category">{{translate('Inactive')}}</option>
                                            </select>
                                        </div>
