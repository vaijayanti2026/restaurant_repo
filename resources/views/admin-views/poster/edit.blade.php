...
@section('title', translate('Update poster'))
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" value="{{$poster['title']}}" class="form-control"
                                            placeholder="{{translate('New Poster')}}" required>
                                    </div>
                                    <div class="form-group">
                                        <label class="input-label">{{translate('Price')}}</label>
                                        <input type="number" min="0" name="price" value="{{$poster['price']}}"
                                        ...
                                        <div class="d-flex justify-content-center mt-4">
                                            <div class="upload-file">
                                                ...
                                                <div class="upload-file__img_drag upload-file__img">
                                                    <img width="465" src="{{asset('storage/app/public/poster')}}/{{$poster['image']}}" onerror="this.src='{{asset('public/assets/admin/img/icons/upload_img2.png')}}'" alt="">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
