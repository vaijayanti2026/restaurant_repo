                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            <label>{{translate('Minimum Miles')}}</label><br>
                                            <input type="number" step=".01" class="form-control" name="minimum_miles"
                                                   value="{{isset($config['minimum_miles'])?$config['minimum_miles']:''}}"
                                                   id="minimum_miles" {{ $config['status']==0?'disabled':'' }}>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
...
@push('script_2')
    ...
    <script>
        $('#shipping_by_distance_status').on('click',function(){
            ...
            $("#minimum_miles").prop('disabled',false);
        });
        ...
        $('#default_delivery_status').on('click',function(){
            ...
            $("#minimum_miles").prop('disabled',true);
        });
    </script>
