                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row g-2">
                                    ...
                                    <div class="col-sm-6">
                                        <label>{{translate('Mail CC')}}</label>
                                        <input type="email" class="form-control" name="mail_cc" value="{{env('APP_MODE')!='demo' && isset($data['mail_cc'])?$data['mail_cc']:''}}" required>
                                    </div>
                                    <div class="col-sm-6">
                                        <label>{{translate('Mail CC')}}</label>
                                        <input type="email" class="form-control" name="mail_cc_sec" value="{{env('APP_MODE')!='demo' && isset($data['mail_cc_sec'])?$data['mail_cc_sec']:''}}" required>
                                    </div>
                                </div>
