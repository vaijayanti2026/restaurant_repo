                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input value="{{old('fax')}}" type="tel" name="fax" class="form-control"
                                               placeholder="{{translate('Ex: +098538534')}}" required>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input value="{{old('tool_free_number')}}" type="tel" name="tool_free_number" class="form-control"
                                               placeholder="{{translate('Ex: +098538534')}}" required>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input value="{{old('square_location_id')}}" type="text" name="square_location_id" class="form-control">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <label class="switcher">
                                            <input class="switcher_input" name="square_status" type="checkbox" {{old('square_status') == 'on' ? 'checked' : ''}}>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input value="{{old('square_application_id')}}" type="text" name="square_application_id" class="form-control">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label class="input-label">Square {{translate('access token')}}</label>
                                        <input value="{{old('square_access_token')}}" type="text" name="square_access_token" class="form-control">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select name="square_environment" class="form-control">
                                            <option value="sandbox" {{old('square_environment', 'sandbox') == 'sandbox' ? 'selected' : ''}}>sandbox</option>
                                            <option value="production" {{old('square_environment') == 'production' ? 'selected' : ''}}>production</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input value="{{old('square_webhook_signature_key')}}" type="text" name="square_webhook_signature_key" class="form-control">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <label class="switcher">
                                            <input class="switcher_input" name="square_commission_status" type="checkbox" {{old('square_commission_status') == 'on' ? 'checked' : ''}}>
                                            <span class="switcher_control"></span>
                                        </label>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select name="square_commission_type" class="form-control">
                                            <option value="percent" {{old('square_commission_type', config('services.square.commission_type', 'percent')) == 'percent' ? 'selected' : ''}}>percent</option>
                                            <option value="fixed" {{old('square_commission_type') == 'fixed' ? 'selected' : ''}}>fixed</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input value="{{old('square_commission_value', config('services.square.commission_value', 0))}}" type="number" step="0.01" min="0" name="square_commission_value" class="form-control">
