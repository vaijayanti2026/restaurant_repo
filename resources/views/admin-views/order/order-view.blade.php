...
{{--                                    </div>--}}
                    ...
                    <div class="py-4 table-responsive">
                        <table class="table table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table">
                            ...
                            @php($add_ons_cost=0)
                            @php($orderAmount=$order->order_amount)
                            @foreach($order->details as $detail)
                                ...
                                <tr>
                                    ...
                                    <td>
                                       ...
                                       src="{{asset('storage/app/public/product/')}}/{{data_get($detail->product, 'image', data_get($product_details, 'image', ''))}}"
                                                 onerror="this.src='{{asset('public/assets/admin/img/160x160/img2.jpg')}}'"
                                                 alt="Image Description">

                                            <div class="media-body text-dark fz-12">
                                                <h6 class="text-capitalize">{{data_get($detail->product, 'name', data_get($product_details, 'name', translate('Product unavailable')))}}</h6>
                                ...
                                <tr><td colspan="6">{{ $detail['instruction'] }}</td></tr>
                                @endif
                        ...
                        <div class="row justify-content-md-end mb-3">
                            <div class="col-md-9 col-lg-8">
                                <dl class="row">
                                    ...
                                    <dt class="col-6">
                                        <div class="d-flex max-w220 ml-auto">
                                            <span>{{translate('Tip Price')}}</span>
                                            <span>:</span>
                                        </div>
                                    </dt>
                                     @php($tipPrice = $order->tip_price ?: 0)
                                    <dd class="col-6 text-dark text-right">{{ \App\CentralLogics\Helpers::set_symbol($tipPrice) }}</dd>
                                    ...
                                    <dd class="col-6 text-dark text-right">
                                        ...
                                        {{ \App\CentralLogics\Helpers::set_symbol($sub_total =$sub_total+$total_tax+$add_ons_cost-$total_dis_on_pro+$tipPrice) }}</dd>
                                ...
                                <dd class="col-6 text-dark text-right">
                                        ...
                                        {{ \App\CentralLogics\Helpers::set_symbol($sub_total =$sub_total-$order['coupon_discount_amount']-$order['extra_discount']) }}</dd>
                                ...
                                <!--<dd class="col-6 border-top pt-2 fz-16 font-weight-bold text-dark text-right">{{ \App\CentralLogics\Helpers::set_symbol($order->order_amount) }}</dd>-->
                                </dl>
                            </div>
                        </div>
                    </div>
                    ...
                    <!--Reward Point deduciton-->
                    <span class="h5 pt-3 pl-3">
                        Reward Point Reedemption:
                    </span>
                    <div class="py-4 table-responsive">
                        <table class="table table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table">
                            <thead class="thead-light">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="media gap-3 w-max-content">
                                            ...
                                            <img class="img-fluid avatar avatar-lg"
                                                 src="{{asset('storage/app/public/reward/')}}/{{$reward['reward']->image}}"
                                                 onerror="this.src='{{asset('public/assets/admin/img/160x160/img2.jpg')}}'"
                                                 alt="Image Description">
                                            </div>
                                    </td>
                                    ...
                                    <td>
                                        {{ $reward['reward']->reward_point }}
                                    </td>
                                    <td>
                                        {{ $reward['reward']->branch_txt }}
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
