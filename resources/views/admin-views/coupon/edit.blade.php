                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="invoice_message" value="{{$coupon['invoice_message']}}" class="form-control"
                                            placeholder="{{ translate('Invoice Message') }}" required>
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-3 col-sm-6">
                                  ...
                                  <div class="col-md-4 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input value="{{$coupon['instructions']}}" type="text" name="instructions" class="form-control" placeholder="Enter Intructions" >
                                    </div>
                                </div>
                            </div>
