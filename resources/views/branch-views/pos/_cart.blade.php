...
<div class="pos-data-table p-3">
    ...
    <form action="{{route('branch.pos.order')}}" id='order_place' method="post">
        ...
        @if(session('pos_square_transaction_reference'))
            <input type="hidden" id="pos_square_reference" name="transaction_reference" value="{{session('pos_square_transaction_reference')}}">
        @endif
        ...
        <div class="pt-4 mb-4">
            ...
            <ul class="list-unstyled option-buttons">
                <li>
                    <input type="radio" id="cash" value="cash" name="type" hidden="" @if(!session('pos_square_transaction_reference')) checked @endif>
                    <label for="cash" class="btn btn-bordered px-4 mb-0">{{translate('Cash')}}</label>
                </li>
                <li>
                    <input type="radio" value="card" id="card" name="type" hidden="" @if(session('pos_square_transaction_reference')) checked @endif>
                    <label for="card" class="btn btn-bordered px-4 mb-0">{{translate('Square')}}</label>
                </li>
