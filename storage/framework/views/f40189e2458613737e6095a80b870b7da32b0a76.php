                                ...
                                <div class="topbar-text dropdown disable-autohide text-capitalize">
                                    <?php if(isset($lang) && array_key_exists('code', $lang[0])): ?>
                                        <a class="topbar-link dropdown-toggle d-flex gap-2 align-items-center font-weight-bold dropdown-toggle-empty" href="#" data-toggle="dropdown">
                                            <img class="avatar-img rounded-0" src="<?php echo e(asset('public/assets/admin/img/flag.png')); ?>" alt="Image Description">
...
<?php /**PATH D:\composer-cache (1)\resources\views/layouts/admin/partials/_header.blade.php ENDPATH**/ ?>