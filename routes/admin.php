...
//        Route::post('/image-upload', 'FileManagerController@upload')->name('image-upload');
        ...
        Route::group(['prefix' => 'pos', 'as' => 'pos.', 'middleware' => ['module:pos_management']], function () {
            ...
            Route::post('square/payment-link', 'POSController@square_payment')->name('square.payment-link');
            Route::get('square/success', 'POSController@square_success')->name('square.success');
        });
        ...
        // shohel 
          Route::group(['prefix' => 'advertisement', 'as' => 'advertisement.', 'middleware' => ['module:promotion_management']], function () {
            Route::get('add-new', 'AdvertisementController@index')->name('add-new');
            ...
            Route::get('list', 'AdvertisementController@list')->name('list');
            Route::get('status/{id}/{status}', 'AdvertisementController@status')->name('status');
            Route::delete('delete/{id}', 'AdvertisementController@delete')->name('delete');
        });
        Route::group(['prefix' => 'tag', 'as' => 'tag.', 'middleware' => ['module:promotion_management']], function () {
            Route::get('add-new', 'TagController@index')->name('add-new');
            ...
            Route::get('status/{id}/{status}', 'TagController@status')->name('status');
            Route::delete('delete/{id}', 'TagController@delete')->name('delete');
        });
        
        Route::group(['prefix' => 'reward', 'as' => 'reward.', 'middleware' => ['module:promotion_management']], function () {
            Route::get('list', '\App\Http\Controllers\Admin\RewardController@list')->name('list');
            Route::post('store', '\App\Http\Controllers\Admin\RewardController@store')->name('store');
            Route::get('edit/{id}', 'RewardController@edit')->name('edit');
            Route::put('update/{id}', 'RewardController@update')->name('update');
            Route::get('status/{id}/{status}', 'RewardController@status')->name('status');
            Route::delete('delete/{id}', '\App\Http\Controllers\Admin\RewardController@delete')->name('delete');
        });
        
        Route::group(['prefix' => 'poster', 'as' => 'poster.', 'middleware' => ['module:promotion_management']], function () {
            Route::get('add-new', 'PosterController@index')->name('add-new');
            Route::post('store', '\App\Http\Controllers\Admin\PosterController@store')->name('store');
            Route::get('edit/{id}', 'PosterController@edit')->name('edit');
            Route::put('update/{id}', 'PosterController@update')->name('update');
            Route::get('list', '\App\Http\Controllers\Admin\PosterController@list')->name('list');
            Route::get('status/{id}/{status}', 'PosterController@status')->name('status');
            Route::delete('delete/{id}', '\App\Http\Controllers\Admin\PosterController@delete')->name('delete');
        });
        ...
        Route::group(['prefix' => 'addon', 'as' => 'addon.', 'middleware' => ['module:product_management']], function () {
         ...
         Route::group(['prefix' => 'badge', 'as' => 'badge.', 'middleware' => ['module:product_management']], function () {
        ...
        Route::group(['prefix' => 'reviews', 'as' => 'reviews.', 'middleware' => ['module:system_management']], function () {
            Route::get('add-new', 'GeneralReviewController@index')->name('add-new');
            Route::post('store', 'GeneralReviewController@store')->name('store');
            Route::get('edit/{id}', 'GeneralReviewController@edit')->name('edit');
            Route::post('update/{id}', 'GeneralReviewController@update')->name('update');
            Route::delete('delete/{id}', 'GeneralReviewController@destroy')->name('delete');
        });
        // shohel
        Route::group(['prefix' => 'rate-us', 'as' => 'rate-us.', 'middleware' => ['module:system_management']], function () {
            Route::get('add-new', 'RateUsController@index')->name('add-new');
            Route::get('list', 'RateUsController@list')->name('list');
            Route::post('store', 'RateUsController@store')->name('store');
            Route::get('edit/{id}', 'RateUsController@edit')->name('edit');
            Route::put('update/{id}', 'RateUsController@update')->name('update');
            Route::delete('delete/{id}', 'RateUsController@delete')->name('delete');
            Route::get('status/{id}/{status}', 'RateUsController@status')->name('status');
        });
        ...
        Route::group(['prefix' => 'orders', 'as' => 'orders.', 'middleware' => ['module:order_management']], function () {
            ...
            Route::get('all-orders', 'AllOrdersController@index')->name('all-orders');
        ...
        Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.', 'middleware' => ['module:system_management']], function () {
            ...
            Route::group(['prefix' => 'web-app', 'as' => 'web-app.', 'middleware' => ['module:system_management']], function () {
                ...
                Route::group(['prefix' => 'system-setup', 'as' => 'system-setup.'], function () {
                    ...
                    Route::get('branch-settings', 'BusinessSettingsController@branchSettings')->name('branch.settings');
                    Route::get('general-settings', 'BusinessSettingsController@generalSettings')->name('general.settings');
                     Route::get('wallet-point-settings', 'BusinessSettingsController@walletPointSettings')->name('wallet.point.settings');
                     Route::get('order-feedback-settings', 'BusinessSettingsController@orderFeedbackEmailSettings')->name('order.feedback.settings');
                    //clean db
...
//            });
        ...
        Route::group(['prefix' => 'customer', 'as' => 'customer.', 'middleware' => ['actch', 'module:user_management']], function () {
            ...
            Route::get('subscribed-emails/export', 'CustomerController@subscribed_emails_export')->name('subscribed_emails.export');
